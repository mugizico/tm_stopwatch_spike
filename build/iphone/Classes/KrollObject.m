...
//@interface tm_stopwatch_spikeObject : NSObject
//@end

@interface tm_stopwatch_spikeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[tm_stopwatch_spikeObject class]])
		{
			for (NSString *key in [[(tm_stopwatch_spikeObject*)o modules] allKeys])
			{
