...
// in simulator we redefine to format for tm_stopwatch_spike Developer console
...
{\
	NSString * exceptionName = [@"org.tm_stopwatch_spike." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tm_stopwatch_spike";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	NSLog(@"[ERROR] %@",message);\
	if ([NSThread isMainThread]==NO) {\
		@throw [NSException exceptionWithName:exceptionName reason:message userInfo:nil];\
...
enum {
	UItm_stopwatch_spikeNativeItemNone = -1, 
	UItm_stopwatch_spikeNativeItemSpinner = -2,
	UItm_stopwatch_spikeNativeItemProgressBar = -3,
	
	UItm_stopwatch_spikeNativeItemSlider = -4,
	UItm_stopwatch_spikeNativeItemSwitch = -5,
	UItm_stopwatch_spikeNativeItemMultiButton = -6,
	UItm_stopwatch_spikeNativeItemSegmented = -7,
	
	UItm_stopwatch_spikeNativeItemTextView = -8,
	UItm_stopwatch_spikeNativeItemTextField = -9,
	UItm_stopwatch_spikeNativeItemSearchBar = -10,
	
	UItm_stopwatch_spikeNativeItemPicker = -11,
	UItm_stopwatch_spikeNativeItemDatePicker = -12,
	
	UItm_stopwatch_spikeNativeItemInfoLight = -13,
	UItm_stopwatch_spikeNativeItemInfoDark = -14,
	
	UItm_stopwatch_spikeNativeItemDisclosure = -15,
	
	UItm_stopwatch_spikeNativeItemContactAdd = -16
};
